...
import com.mini.backend.backEND.repository.VerificationTokenRepository;
import com.mini.backend.backEND.security.JwtProvider;
...
public class AuthService {
    ...
    private final String url ="typical-cat-production.up.railway.app";
    ...
    public void signup(RegisterRequest registerRequest) {
        ...
        mailService.sendMail(new NotificationEmail("Please Activate your Account",
                user.getEmail(), "Thank you for signing up to My MiniProject, " +
